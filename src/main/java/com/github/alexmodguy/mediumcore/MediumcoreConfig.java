...
public class MediumcoreConfig {
    ...
    public MediumcoreConfig(final ForgeConfigSpec.Builder builder) {
        ...
        minimumPlayerHealth = builder.comment("The lowest amount of max health a player can have in mediumcore. Health will not decrease beyond this threshold no matter how many deaths are taken. Default is 0 HP, which is 0 hearts.").translation("minimum_player_health").defineInRange("minimum_player_health", 0.0D, 0.0D, 1000.0D);
