...
public class MediumcoreConfig {
    ...
    public MediumcoreConfig(final ForgeConfigSpec.Builder builder) {
        ...
        minimumPlayerHealth = builder.comment("The lowest amount of max health a player can have in mediumcore. Default is 0 HP, allowing players to lose all hearts.").translation("minimum_player_health").defineInRange("minimum_player_health", 0.0D, 0.0D, 1000.0D);
